...
const navItems = [
    ...
    { href: '/admin/error-tracking', label: 'Error Tracking' },
    { href: '/admin/revenue', label: 'Revenue/MRR' },
    { href: '/admin/api-monitoring', label: 'API Monitoring' },
    { href: '/admin/cohorts', label: 'Cohort Analysis' },
    { href: '/admin/compliance', label: 'Compliance' },
    { href: '/admin/ab', label: 'A/B Testing' },
    { href: '/admin/segments', label: 'Segments' },
    { href: '/admin/campaigns', label: 'Push Campaigns' },
